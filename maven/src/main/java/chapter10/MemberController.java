...
public class MemberController {
	...
	public String index(Model model) {
		...
		model.addAttribute("name1", "손흥민"); // 타임리프 테스트
		model.addAttribute("name2", "<b>이강인</b>"); // 타임리프 테스트
		model.addAttribute("name3", "<b>박지성</b>"); // 타임리프 테스트
		return "member/index";
	}
...
//	}
	...
	public String insert(MemberVo vo, Model model, HttpServletRequest req) throws Exception {
		int result = memberService.insert(vo, req);
